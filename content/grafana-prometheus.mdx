...
In this article, I will explain how to set up Prometheus and Grafana and create a monitoring dashboard for your Kubernetes Cluster and its components. Before we dive in, here are the manifest files you need throughout this article.
...
As I mentioned before, you can access the manifest files on that repository: https://github.com/ahmethedev/grafana-prometheus
